import { o as __toESM, t as require_react } from "./react-B5M7kIxm.js";
...
function classesToTokens(classes$1 = "") {
	return classes$1.trim().split(" ").filter((c) => !!c.trim());
}
...
function createElement(tag, classes$1 = []) {
	const el = document.createElement(tag);
	el.classList.add(...Array.isArray(classes$1) ? classes$1 : classesToTokens(classes$1));
	return el;
}
